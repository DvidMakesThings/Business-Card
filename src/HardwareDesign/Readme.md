# # Business_Card_LA Project Hardware Design Files

## Contents
This folder contains the hardware design files for the Business_Card_LA project. The main components include:
- Schematic diagrams
- PCB layouts
